...
export function grammar_alloc(size: number, align: number): number;
/**
...
export interface InitOutput {
  ...
  readonly grammar_alloc: (a: number, b: number) => number;
  ...
  readonly closure5413_externref_shim: (a: number, b: number, c: any) => void;
